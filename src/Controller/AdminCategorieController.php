...
final class AdminCategorieController extends AbstractController
{
    ...
    {
        if (!$this->isCsrfTokenValid('delete'.$categorie->getId(), $request->request->getString('_token'))) {
        ...
        $count = $categorie->getFormations()->count();
        ...
        try {
            ...
            $this->addFlash('error', 'Impossible de supprimer la catégorie : ' . $e->getMessage());
        }

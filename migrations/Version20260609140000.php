...
final class Version20260609140000 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        $this->addSql("ALTER TABLE home_page_content
            ...
            ADD hero_cta_primary_label VARCHAR(128) NOT NULL DEFAULT 'Découvrir les formations',
            ...
            ADD stat2_label VARCHAR(255) NOT NULL DEFAULT 'Formations interactives',
            ...
            ADD audience_card1_title VARCHAR(255) NOT NULL DEFAULT 'Formation INTRA',
            ADD audience_card1_text TEXT NOT NULL DEFAULT (''),
            ADD audience_card1_icon VARCHAR(64) NOT NULL DEFAULT 'building',
            ADD audience_card2_title VARCHAR(255) NOT NULL DEFAULT 'Formation INTER',
            ...
            ADD service2_title VARCHAR(255) NOT NULL DEFAULT 'Formations Pratiques',
        ...
        $this->addSql("UPDATE home_page_content SET
            ...
            audience_lead = 'Nos formations s''adressent aux équipes et managers qui veulent progresser',
            ...
            contact_lead = 'Une question sur nos formations ? Écrivez-nous, nous vous répondrons dans les meilleurs délais.'");
    }
